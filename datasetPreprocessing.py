...
# Download deliveries_2008-2024.csv from Google Drive if not present
if not os.path.exists('deliveries_2008-2024.csv'):
    try:
        import gdown
    except ImportError:
        import subprocess
        ...
        import gdown
    file_id = '1-HRYfJVaoAheSTH6sje3U9Sk-p3cuqJo'
    gdown.download(f'https://drive.google.com/uc?id={file_id}', 'deliveries_2008-2024.csv', quiet=False)
