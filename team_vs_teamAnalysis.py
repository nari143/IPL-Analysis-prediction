...
def app():
    ...
    combine_df['season'] = combine_df['id'].map(new_matchesDF.set_index('id')['season'])
    ...
    if t1 == t2:
        ...
        if Analyze:
            ...
            if total.empty:
                ...
                plt.title(f'{t1} vs {t2} : Match Winners', fontsize=10,color='white')
                plt.xlabel('Teams',color='white')
                plt.ylabel('Winning Count',color='white')
                ...
                plt.title(
                    f"Number of fours Hitted By Players of Team {t2} vs {t1}",color='white'
                )
                plt.ylabel('Players',color='white')
                plt.xlabel('Number of fours',color='white')
